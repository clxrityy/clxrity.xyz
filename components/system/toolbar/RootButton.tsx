...
export const RootButton = () => (
  ...
  <button
    title="Root"
    type="button"
    className={`h-15 w-18 shadow-inner flex rounded-md items-center justify-center transition-all duration-100 ease-linear bg-gradient-to-r from-[var(--background-start)]/15 to-[var(--background-start)]/5 focus:bg-transparent focus:scale-[92.5%] focus:contrast-200 focus:drop-shadow-lg place-items-center place-content-center`}
  >
    <ImageComponent
      image={{
        src: "/apple-touch-icon.png",
